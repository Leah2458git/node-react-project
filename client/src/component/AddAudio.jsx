...
export default function AddVideo() {
    ...
    const [isNameEntered, setIsNameEntered] = useState(false); // סמן לבדיקה האם השם הוזן
    const roles = [
    ...
    const handleNameChange = (e) => {
        ...
        setIsNameEntered(!!e.target.value); // אם השם הוזן, הכפתור יופיע
    };
        ...
        <div className="p-fluid p-grid p-formgrid">
            ...
            <div className="p-field p-col-12">
                ...
                <Dropdown 
                    ...
                    style={{ width: '100%', marginBottom: '10px' }}
                />
                {isNameEntered && ( // הצגת הכפתור רק אם השם הוזן
                    <FileUpload 
                        name="path" 
                        customUpload 
                        accept="audio/*"
